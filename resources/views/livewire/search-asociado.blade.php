    ...
    <div class="card mb-0 border-0 shadow-sm">
        <div class="card-body">
            <div class="form-group mb-0">
                 <label for="">Buscar asociado</label>
                <div class="input-group">
                     <input wire:keydown.escape="resetQuery" wire:model.debounce.500ms="query" type="text" class="form-control" placeholder="Buscar por cif o dpi">
                    ...
                    <ul class="list-group list-group-flush">
                        @foreach($search_results as $result)
                            <li class="list-group-item list-group-item-action">
                                <a wire:click="resetQuery" wire:click.prevent="selectAsociado({{ $result }})" href="#">
                                    {{ $result->cif }} | {{ $result->dpi }} | {{ $result->name }}
                                </a>
                            </li>
                        @endforeach
