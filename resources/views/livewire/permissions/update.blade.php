        ...
        <div class="modal-content">
            ...
            <div class="modal-body pb-5 px-sm-5 pt-50">
                <div class="text-center mb-2">
                    <h1 class="mb-1">EDITAR PERMISO</h1>
                 ...
                 <div class="row">
                     ...
                     <div class="col-sm-6 mt-1">
                         <div class="form-group">
                            ...
                            <select wire:model="slug" class="form-control" id="slug" placeholder="slug">
                     ...
                     <div class="col-sm-12 mt-1">
                         ...
                         <textarea wire:model="descripcion" id="descripcion" cols="30" rows="5" class="form-control"></textarea>
                     </div>
                 </div>
                 <div class="col-sm-12 mt-1">
                         <div class="form-group">
                            <label for="username">Estado del permiso</label>
                            <select wire:model="status" class="form-control"  placeholder="status">
                                <option value="">Seleccione</option>
