...
class EmpresaController extends Controller
{
    ...
    public function index()
    {
         ...
         if(\Gate::denies('empresa_access'))
        {
            ...
            $logs->descripcion = 'El usuario: '.\Auth::user()->name.' Ha ingresado al módulo de empresas en el sistema el día '.date('d').' del mes '.date('m').' del presente año a las '.date('H:i:s');
